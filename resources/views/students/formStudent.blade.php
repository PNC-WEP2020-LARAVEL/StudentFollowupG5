                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('save') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gender" type="radio" name="gender" value="{{ old('male') }}" required autocomplete="gender" autofocus> Male
                                <br><input id="gender" type="radio" name="gender" value="{{ old('female') }}" required autocomplete="gender" autofocus> Female
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="picture" type="file" name="picture" value="{{ old('picture') }}" required autocomplete="picture" autofocus>
